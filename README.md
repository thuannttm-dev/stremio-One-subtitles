...
Fetches subtitles from the public Stremio OpenSubtitles v3 addon, translates them with `googletrans`, and serves generated WebVTT subtitles to Stremio. No OpenSubtitles credentials are required.
